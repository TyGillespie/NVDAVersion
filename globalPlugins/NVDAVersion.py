...
class GlobalPlugin(globalPluginHandler.GlobalPlugin):
	@script(gesture="kb:NVDA+shift+v", description="Speak the current NVDA version.")
	def script_announceNvdaVersionRegular(self, gesture):
		ui.message("Version " + versionInfo.version)

	@script(gesture="kb:NVDA+shift+control+v", description="Show the current version of NVDA in a dialog.")
